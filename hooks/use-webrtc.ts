...
export default function useWebRTCAudioSession(
  ...
  function registerFunction(name: string, fn: Function) {
    console.log('Registering function in WebRTC hook:', name);
    functionRegistry.current[name] = fn;
    console.log('Current function registry:', Object.keys(functionRegistry.current));
  }
    ...
    try {
      ...
      switch (msg.type) {
        ...
        case "response.function_call_arguments.done": {
          console.log('Function call received:', msg.name, 'with args:', msg.arguments);
          const fn = functionRegistry.current[msg.name];
          console.log('Registered functions:', Object.keys(functionRegistry.current));
          console.log('Function found:', !!fn);
          console.log('Current session active:', isSessionActive);
